...
sentencia: 	expr '=' expr ';'							{ $$ = new Asignacion($1, $3); }
			...
			| 'PRINT'   expr ';'						{ $$ = new Escritura($2, "print"); }
			...
			| 'IDENTIFICADOR' '(' listaExprSeparadorOpt ')' ';'					{ $$ = new InvFuncSent($1, $3); } 					
			;			
	
listaExprSeparadorOpt: listaExprSeparador											{ $$ = $1; }
...
expr:  		expr '+' expr 				{ $$ = new ExpresionBinaria($1, "+" ,$3); }	
		  ...
		  | 'IDENTIFICADOR' '(' listaExprSeparadorOpt ')'			{ $$ = new InvFuncExpr($1, $3); }	
		  ;
